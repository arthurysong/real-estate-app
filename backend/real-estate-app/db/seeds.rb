...
home_6 = Home.create(zipcode: zip_code_2, price: 237000, address: "10621 E Avalon Park St, Tucson, AZ 85747", bedrooms: 3, bathrooms: 2, sqft: 1794, year_built: 2003 );
home_7 = Home.create(zipcode: zip_code_2, price: 211000, address: "10024 E Paseo San Ardo, Tucson, AZ 85747", bedrooms: 4, bathrooms: 3, sqft: 2177, year_built: 1996 );
home_8 = Home.create(zipcode: zip_code_2, price: 200000, address: "8697 S Desert Rainbow Dr, Tucson, AZ 85747", bedrooms: 3, bathrooms: 3, sqft: 1765, year_built: 1998 );
home_9 = Home.create(zipcode: zip_code_2, price: 220000, address: "8944 E Martha Root Ct, Tucson, AZ 85747", bedrooms: 3, bathrooms: 2, sqft: 1339, year_built: 1998 );
home_10 = Home.create(zipcode: zip_code_2, price: 185000, address: "9821 E Stonehaven Way, Tucson, AZ 85747", bedrooms: 3, bathrooms: 2, sqft: 1358, year_built: 1995 );
